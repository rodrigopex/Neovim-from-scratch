...
local mappings = {
    ...
    l = {
        ...
        d = { "<cmd>lua require('telescope.builtin').diagnostics(require('telescope.themes').get_ivy {bufnr = 0})<cr>",
            "Buffer diagnostics",
        },
        w = {
        ...
        R = { "<cmd>lua require('telescope.builtin').lsp_references(require('telescope.themes').get_dropdown{previewer = false})<cr>",
            "Refs to the word",
        },
    ...
    i = {
        name = "Insert",
        n = { "<cmd>lua require('neogen').generate()<CR>", "Annotation comment" },
    },
    t = {
        name = "Terminal",
